        ...
        case (size_data)
            HSIZE_BYTE: begin
                case (addr_data[1:0])
                    ...
                    2'b01: rdata_extracted = {16'h0, HRDATA[15:8], 8'h0};
                    2'b10: rdata_extracted = {8'h0, HRDATA[23:16], 16'h0};
                    2'b11: rdata_extracted = {HRDATA[31:24], 24'h0};
                endcase
            end
    
            HSIZE_HALFWORD: begin
                if (addr_data[1]) rdata_extracted = {HRDATA[31:16], 16'h0};
